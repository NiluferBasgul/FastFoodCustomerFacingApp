...
import IngredientSelector from "components/DesignYourOwnPizza/IngredientSelector";
...
export interface DesignYourOwnPizzaPageWithoutRouterProps {
    slug?: string;
    id?: string;
    item?: MenuItem;
}

const DesignYourOwnPizzaPage = (props: DesignYourOwnPizzaPageWithoutRouterProps) => {
    ...
    const internalId = id || `pbd-${randomID()}`;
    ...
    useEffect(() => {
        dispatch({ type: "SELECT_PRODUCT", payload: { ...pizza, internalId, menuCategory: MenuCategoryType.PIZZAS } });
        ...
        <Layout disableFooter={true}>
            ...
            <div className="container-sm">
                <div className='row d-flex align-items-center'>
                    ...
                    <div className='col-9'>
                        <h1 className="font-weight-bold p-0 m-0 text-end">{t`designYourOwnPizza`}</h1>
                    </div>
                </div>
            </div>
            ...
            <div className='container-sm mt-3'>
                <div className='row'>
                    <div className="col-12 col-md-4">
                        <SingleProductHeader
                            name={t`designYourOwnPizza`}
                            price={basePrice}
                            slug={internalId as FoodSlug}
                            menuCategory={MenuCategoryType.PIZZAS}
                            imgSrc={'defaultpizzabydesignimgpath'}
                    ...
                    {
                        Object.values(IngredientType).map(ingredientType => <>
                            <div className="container-sm mt-4">
                                <div className='card'>
                                    <div className='card-body'>
                                        <div className="header">
                                            <div className="header-body py-2">
                                                <h2 className="header-title">
                                                    {t(`pickBase${ingredientType}`, { menuCategory: MenuCategoryType.PIZZAS })}
                                                </h2>
                                            </div>
                                        </div>
                                        <IngredientSelector ingredientCategoryFilter={ingredientType} />
                                    </div>
                                </div>
                            </div>
                        </>)
