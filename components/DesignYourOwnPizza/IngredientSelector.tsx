import { EnhancedIngredients, IngredientType, KEYS, StandartIngredients } from "data/cucinaTree";
...
const filterIngredientsByCategory = (ingredients: EnhancedIngredients, category: IngredientType) => {
    const copyIngredients = { ...ingredients };

    for (const name in copyIngredients) {
        if (copyIngredients.hasOwnProperty(name) && copyIngredients[name]?.category !== category) {
            delete copyIngredients[name];
        }
    }
...
interface ExtraIngredientsProps {
    ingredientCategoryFilter?: IngredientType;
}

const IngredientSelector = (props: ExtraIngredientsProps) => {
    ...
    const initialIngredients = props.ingredientCategoryFilter ? filterIngredientsByCategory(StandartIngredients, props.ingredientCategoryFilter) : { ...StandartIngredients };
